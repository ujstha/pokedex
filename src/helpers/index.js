...
export const getPokemonAnimatedImageURL = (id) =>
  `${POKEMON_IMAGE_ANIMATED_URL}/${id}.gif`;

export const increaseImageHeightInPx = (height, increment) =>
  `${height * increment}px`;
